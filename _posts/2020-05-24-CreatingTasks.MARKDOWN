...
2. Activate the tasks so that the patient can use these tasks. See the [`PUT /MeasurementStagings` endpoint](https://nikhil-mukunda.github.io/APIDocs/#/Activate%20the%20tasks/ActivateMeasurement). 
